...
for D in /home/*; do
	if [ -d "${D}" ]; then #If a directory
		...
		echo "- "$domain;
		zip -r $BACKUP_DIR/$domain.zip /home/$domain/public_html/ -q -x /home/$domain/public_html/wp-content/cache/**\* /home/$domain/public_html/node_modules/**\* /home/$domain/public_html/vendor/**\* /home/$domain/public_html/.git/**\* /home/$domain/public_html/storage/framework/**\* /home/$domain/public_html/storage/debugbar/**\* #Exclude cache
	fi
done
echo "Finished";
echo '';
